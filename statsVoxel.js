var Stats = function() {
    ...
    container.style.cssText = 'position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000;left:270px;';
    ...
    var msPanel = addPanel(new Stats.Panel('VMS', '#f0f', '#202'));
